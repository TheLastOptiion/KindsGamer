...
This folder contains all the style sheet files.

 
-------------------------fonts-------------------------------

This folder contains all the fonts used and glyphicons.

-------------------------home-----------------------------------------------------

  -> u_home.php
       This folder contains the file 'u_home.php' it's included in the file 'home.php'.
...
This folder contains all java script file included in every web page.

----------------------------login-----------------------------------------------------

This folder contains :
  -> 'login1.php' included in 'index.php' (first page every user will see).
  -> 'u_login.php' included in 'login.php' (login fourm).
  -> 'user_display.php' included in 'nearest.php' (Display content).

----------------------------signup----------------------------------------------------

This folder contains :
  -> 'u_signup.php' included in 'signup.php' (signup fourm).
...
----------------------------------------.htaccess------------------------------------------------
 ...
 ->Contains code for maximizing the file size limit to upload it successfully. 
